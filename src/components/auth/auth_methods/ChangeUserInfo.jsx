...
const ChangeUserInfo = ({ setProfileUpdated }) => {
  ...
  return (
    <>
      ...
      <div className="section-heading border-b-grey text-sh-grey m-auto mb-3 flex w-[50%] justify-between border-b border-solid text-xs">
        <p className="hover:text-hov-blue text-sm uppercase">
      ...
      <div className="section-heading  border-b-grey text-sh-grey m-auto mb-3  mt-4  flex  w-[50%] justify-between  border-b  border-solid  text-xs">
        <p className="hover:text-hov-blue text-sm">CHANGE YOUR BIO</p>{" "}
      </div>
      <div
        className="m-auto 
        flex
